...
*** Canvas HTML \\ Exemple 1
    ...
    \lstinputlisting[language=html, firstline=8, lastline=9]{examples/canvas2.html}
    \end{block}

    \begin{block}{Contour de zone}
    \lstinputlisting[language=js, firstline=11, lastline=12]{examples/canvas2.js}
    \end{block}

    \begin{block}{Tracé}
    \lstinputlisting[language=js, firstline=14, lastline=20]{examples/canvas2.js}
    \end{block}

	 \vfill

    \begin{center}
    \includegraphics[width=\textwidth]{img/canvas-ex2.png}
    \end{center}
	 #+end_latex
