...
*** Couleurs \\ Synchronisation
    ...
    #+Latex: \codeinput{js}{examples/donnees_serveur.js}{}
	 ...
	 - Choisit une teinte aléatoire et broadcast

	 Déconnexion d'un client :
	 - Supprime la teinte et broadcast
    ...
    #+Latex: \codeinput{js}{examples/donnees_client.js}{}
	 ...
	 Connexion d'un client :
	 - Enregistre le nouvel utilisateur et sa teinte

    Déconnexion d'un client :
	 - Supprime la teinte locale
...
*** Tracé \\ Segment par segment
    ...
    \includegraphics[width=5cm]{img/line2.png}
	 ...
	 Comment communiquer le tracé d'une ligne ?
...
*** Tracé \\ Synchronisation
	 ...
	 - Enregistre la position du curseur à chaque \code{mousemove}
	 ...
	 - Détermine la teinte du segment en fonction du dessinateur
	 - Dessine le segment sur le canvas
