...
#+Latex_Header: \lstset{aboveskip=0pt, belowskip=0pt}

#+Latex_Header: \lstnewenvironment{javascript}
#+Latex_Header: {\lstset{ language={C}, morekeywords={var, function}, keywordstyle=\color{Lime}\bfseries, stringstyle=\color{Grue} }}{}

#+Latex_Header: \lstnewenvironment{coffeescript}
#+Latex_Header: {\lstset{ language={Ruby}, morekeywords={of}, stringstyle=\color{Grue} }}{}

#+Latex_Header: \lstnewenvironment{shell}
#+Latex_Header: {\lstset{ language={bash}, stringstyle=\color{Grue} }}{}
...
server.on('leave', function(user) { leave(user); });\end{javascript}
	 \end{block}
	 #+end_latex
...
Prérequis:
    #+begin_latex
	 \begin{block}{}
	 \begin{shell}
sudo apt-get install build-essential git\end{shell}
	 \end{block}
	 #+end_latex
